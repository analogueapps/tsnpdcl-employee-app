                ...
                Expanded(
                  child: viewModel.isLoading
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        title: Text('SURVEY ID: ${item.surveyId ?? 'N/A'}'),
                        subtitle: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                          Text('Work Description: ${item.workDescription ?? 'N/A'}'),
                          Text(item.feederName ?? 'N/A'),
                          Text('LatA:${item.beforeLat ?? 'N/A'}'),
                          Text('LonA:${item.pbeforeLon ?? 'N/A'}'),
                          Text(item.dateOfBeforeMarked ?? 'N/A',style: TextStyle(color: Colors.blue),),
                            SizedBox(width: 10,),
                              Align(
                        ...
                        trailing: Text( item.status ?? 'N/A', style: TextStyle(color: item.status=="PENDING"? Colors.red: Colors.green, fontSize: 15),),
