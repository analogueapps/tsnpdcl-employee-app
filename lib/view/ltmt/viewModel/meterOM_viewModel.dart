...
//   final BuildContext context;
//
//   bool _isLoading = false; // Start as false, only true during API calls
//   bool get isLoading => _isLoading;
//
//   List<MeterStockEntity> _meterStockEntityList1 = [];
//
...
//                     final staffList = jsonDecode(cleanedJsonString) as List;
//                     dataList =
//                         staffList.map((json) => LoadStaffEntity.fromJson(json))
//                             .toList();
//                   } else if (jsonList is List) {
//                     dataList =
//                         jsonList.map((json) => LoadStaffEntity.fromJson(json))
//                             .toList();
//                   }
//
//                   _loadStaffEntityList.clear(); // Clear old data
//                   _loadStaffEntityList.addAll(dataList);
//                   showStaffDialog(context);
//                   print("Staff data: ${_loadStaffEntityList
//                       .length} items loaded");
//                   notifyListeners();
//                 } catch (e, stackTrace) {
//                   print("Error parsing objectJson: $e");
...
//                     }
//                     final parsedList = jsonDecode(cleanedJsonString) as List;
//                     dataList = parsedList.map((json) =>
//                         MeterStockEntity.fromJson(json)).toList();
//                   } else if (jsonList is List) {
//                     dataList =
//                         jsonList.map((json) => MeterStockEntity.fromJson(json))
//                             .toList();
//                   }
//
//                   _meterStockEntityList1.clear(); // Clear old data
//                   _meterStockEntityList1.addAll(dataList);
//                   print("Meters data: ${meterStockEntityList1
//                       .length} items loaded here");
//                   notifyListeners();
//                 } catch (e, stackTrace) {
//                   print("Error parsing objectJson: $e");
//                   print("Stack trace: $stackTrace");
...
//                             return ListTile(
//                               title: Text(
//                                   "${staffName.name ?? 'N/A'}, ${staffName
//                                       .designation ?? 'N/A'}"),
//                               onTap: () async {
//                                 selectedEmpID = staffName.employeeId!;
//                                 print("Selected Staff ID: $selectedEmpID");
//                                 Navigator.pop(context); // Close dialog
//                                 await getLoaderLoadMetersStock(); // Fetch meter data
//                                 Navigation.instance.navigateTo(
//                                     Routes.meterOM, ); // Navigate to MetersOm
//                               },
//                             );
//                           },
//                         ),
