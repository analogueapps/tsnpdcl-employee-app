                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        if (selectedItem == null) {
                          ...
                          print(
                              "assignDtrMaintenance api call: ${item.regId} ${selectedItem!.empId}");
                      ...
                      Visibility(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            DropdownButtonFormField<EroModel>(
                              value: make,
                              hint: Text(categoryChange.meterMake,
                                      style: TextStyle(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () async {
                          if (selectedOption == "Accept" &&
                            ...
                            updateCatChangeApplication(categoryChange.regId, "",
