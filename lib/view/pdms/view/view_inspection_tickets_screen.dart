            ...
            appBar: AppBar(
              ...
              title: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    viewModel.inspectionTicketEntityList.isNotEmpty
                        ? "Showing ${viewModel.inspectionTicketEntityList.length} Ticket(s)"
                        : "No Ticket(s)",
                    style: const TextStyle(
                ...
                : viewModel.inspectionTicketEntityList.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          final item =
                              viewModel.inspectionTicketEntityList[index];
                          return GestureDetector(
                            onTap: () {
                              Navigation.instance.navigateTo(
                                  Routes.viewDetailedInspectionTicketScreen,
                                ...
                                Row(
                                  children: [
                                    ...
                                    IconButton(
                                        onPressed: () {
                                          Navigation.instance.navigateTo(
                                              Routes.viewDetailedDiTabsScreen,
                                              args: jsonEncode(item));
                                        },
                                        icon: const Icon(
