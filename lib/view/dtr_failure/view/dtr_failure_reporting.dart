            ...
            appBar: AppBar(
              ...
              title: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                const Text('Report DTR failure',style: const TextStyle(
                color: Colors.white,
              ...
              child: Padding(
                ...
                child: Form(
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    ..._buildStructureDetails(viewModel.structureData.first),
                    const SizedBox(height: 20),
                    if (viewModel.structureData.isNotEmpty &&
                        viewModel.structureData.first.dtrs != null &&
                        viewModel.structureData.first.dtrs!.isNotEmpty)
                      _buildDTRDetails(viewModel.structureData.first.dtrs!.first),
                    ...
                    Column(
                    children: [
                    _buildCheckboxRow(viewModel, 'High Rating HG Fuses Used', 'High Rating HG Fuses Used'),
                    _buildCheckboxRow(viewModel, 'High Rating LT Fuses Used', 'High Rating LT Fuses Used'),
                    _buildCheckboxRow(viewModel, 'Vent Pipe Burst', 'Vent Pipe Burst'),
                    _buildCheckboxRow(viewModel, 'Gasket damaged at tank cover', 'Gasket damaged at tank cover'),
                    _buildCheckboxRow(viewModel, 'Earth wire cut', 'Earth wire cut'),
                    _buildCheckboxRow(viewModel, 'Loose lines in the LT Line', 'Loose lines in the LT Line'),
                    _buildCheckboxRow(viewModel, 'Phase Touching to Ground/Tree', 'Phase Touching to Ground/Tree'),
                    _buildCheckboxRow(viewModel, 'Ph Touching to body internally', 'Ph Touching to body internally'),
                    _buildCheckboxRow(viewModel, 'Due to lightning', 'Due to lightning'),
                    _buildCheckboxRow(viewModel, 'Heavy Wind and Gale', 'Heavy Wind and Gale'),
                    _buildCheckboxRow(viewModel, 'DTR installed long back', 'DTR installed long back'),
                    _buildCheckboxRow(viewModel, 'Improper HG Fuse wire', 'Improper HG Fuse wire'),
                    _buildCheckboxRow(viewModel, 'Improper LT Fuse wire', 'Improper LT Fuse wire'),
                    _buildCheckboxRow(viewModel, 'Tank Crack OR Oil Leakage', 'Tank Crack OR Oil Leakage'),
                    _buildCheckboxRow(viewModel, 'Moisture Entry', 'Moisture Entry'),
                    _buildCheckboxRow(viewModel, 'Flashover of Bushing', 'Flashover of Bushing'),
                    _buildCheckboxRow(viewModel, 'Improper Earthing', 'Improper Earthing'),
                    _buildCheckboxRow(viewModel, 'Overload', 'Overload'),
                    _buildCheckboxRow(viewModel, 'HG Fuse Not Standing', 'HG Fuse Not Standing'),
                    _buildCheckboxRow(viewModel, 'Fault due to AGL Motor', 'Fault due to AGL Motor'),
                    _buildCheckboxRow(viewModel, 'Oil Gushing Out', 'Oil Gushing Out'),
                    _buildCheckboxRow(viewModel, 'Low Oil Level', 'Low Oil Level'),
                    _buildCheckboxRow(viewModel, 'Tank Burst', 'Tank Burst'),
                    _buildCheckboxRow(viewModel, 'Aging of DTR', 'Aging of DTR'),
                    _buildCheckboxRow(viewModel, 'Theft of Oil', 'Theft of Oil'),
                    _buildCheckboxRow(viewModel, 'Floods-DTR Fallen-Oil shrt, Bushings dmgd', 'Floods-DTR Fallen-Oil shrt,\n Bushings dmgd'),
                    _buildCheckboxRow(viewModel, 'floodsSubmergedFloods-DTR submerged in water', 'Floods-DTR submerged in water'),
                  ...
                  if (viewModel.isLoading|| viewModel.isLoadingStructureDetails||viewModel.isLoadingStructures)
                    Positioned.fill(
                      child: Container(
