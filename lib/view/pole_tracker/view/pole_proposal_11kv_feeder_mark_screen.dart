...
import 'package:tsnpdcl_employee/view/pole_tracker/viewmodel/pole_proposal_11kv_feeder_mark_viewmodel.dart';
import 'package:tsnpdcl_employee/widget/primary_button.dart';
import 'package:tsnpdcl_employee/widget/view_detailed_lc_tile_widget.dart';

class PoleProposal11kvFeederMarkScreen extends StatelessWidget {
  static const id = Routes.poleProposal11kvFeederMarkScreen;
  final Map<String, dynamic> args;

  const PoleProposal11kvFeederMarkScreen({
    super.key,
    required this.args,
  });
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => PoleProposal11kvFeederMarkViewmodel(context: context, args: args),
      child: Consumer<PoleProposal11kvFeederMarkViewmodel>(
...
Widget checkbox(BuildContext context, String title, String? selected,
  ...
  return Consumer<PoleProposal11kvFeederMarkViewmodel>(
    builder: (context, viewModel, child) {
      return Row(
