...
class DtrHtMaintenanceEntry extends StatelessWidget {
  const DtrHtMaintenanceEntry(
      {super.key, required this.data, required this.selectedOption});
  final String data;
          ...
          child: Column(
            ...
            children: [
              ...
              Visibility(
                ...
                child: Column(
                  ...
                  children: [
                    const Padding(
                      padding:
                          EdgeInsets.only(top: doubleFive, bottom: doubleFive),
                      child: Text(
                        "AB Switch Type",
                        style: TextStyle(
                          fontSize: doubleThirteen,
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: viewModel.isAbSwitchStatusDisabled
                              ...
                              : () {
                                  viewModel
                                      .selectAbSwitchStatus(Status.Damaged);
                                },
                          child: const Text(
                            "Damaged/Not Working",
                            style: TextStyle(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: viewModel.isKv11HgFuseSetDisabled
                        ...
                        : () {
                            viewModel
                                .selectKv11HgFuseSet(AbSwitch.NotAvailable);
                          },
                    child: const Text(
                      "Not Available",
                      style: TextStyle(
                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child: DropdownButton<String>(
                            ...
                            hint: const Text("SELECT"),
                            items: viewModel
                                .spinner11HgFsHornsToReplaced!.options
                                .map((option) {
                              return DropdownMenuItem<String>(
                                value: option.optionId,
                                child: Text(option.optionName!),
                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child: DropdownButton<String>(
                            ...
                            hint: const Text("SELECT"),
                            items: viewModel.spinner11HgFsGapNotCorrect!.options
                                .map((option) {
                              return DropdownMenuItem<String>(
                                value: option.optionId,
                                child: Text(option.optionName!),
                            ...
                            onChanged: (value) {
                              viewModel.spinner11HgFsGapNotCorrectValueSelected(
                                  value);
                            },
                          ),
                        )
                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child: DropdownButton<String>(
                            ...
                            hint: const Text("SELECT"),
                            items: viewModel
                                .spinner11HgFsPostTypeInsulatorsDamaged!.options
                                .map((option) {
                              return DropdownMenuItem<String>(
                                value: option.optionId,
                                child: Text(option.optionName!),
                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child: DropdownButton<String>(
                            ...
                            onChanged: (value) {
                              viewModel
                                  .spinnerHtBushDamagedQtyValueSelected(value);
                            },
                          ),
                        )
                      ],
                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child: DropdownButton<String>(
                            ...
                            hint: const Text("SELECT"),
                            items: viewModel
                                .spinnerHtBushRodsDamagedQty!.options
                                .map((option) {
                              return DropdownMenuItem<String>(
                                value: option.optionId,
                                child: Text(option.optionName!),
              ...
              ViewDetailedLcImageWidget(
                  imageUrl: checkNull(viewModel
                      .dtrInspectionSheetEntity?.beforeMaintenanceImage)),
              const SizedBox(
                height: doubleTwenty,
              ),
            ],
          ...
          child: Column(
            ...
            children: [
              ...
              radioGroupWidget(
                ...
                "Good",
                "Damaged",
                viewModel.ltBushStatus,
                viewModel.isLtBushStatusDisabled,
                (value) => viewModel.selectLtBushStatus(value),
              ),
              radioGroupWidget(
                "LT Bushes Rods",
                Status.Good,
                ...
                "Good",
                "Damaged",
                viewModel.ltBushRodStatus,
                viewModel.isLtBushRodStatusDisabled,
                (value) => viewModel.selectLtRodBushStatus(value),
              ),
              ...
              radioGroupWidget(
                ...
                "Available",
                "Not Available",
                viewModel.ltBiMetalicClamps,
                viewModel.isLtBiMetalicClampsDisabled,
                (value) => viewModel.selectLtBiMetalicClamps(value),
              ),
              radioGroupWidget(
                "Clamps Status",
                Status.Good,
                ...
                "Good",
                "Damaged",
                viewModel.clampsStatus,
                viewModel.isClampsStatusDisabled,
                (value) => viewModel.selectClampsStatus(value),
              ),
              radioGroupWidget(
                "LT Breaker",
                AbSwitch.Available,
                ...
                "Not Available",
                viewModel.ltBreaker,
                viewModel.isLtBreakerDisabled,
                (value) => viewModel.selectLtBreaker(value),
              ),
              radioGroupWidget(
                "LT Breaker Status",
                Status.Good,
                ...
                "Good",
                "Damaged",
                viewModel.ltBreakerStatus,
                viewModel.isLtBreakerStatusDisabled,
                (value) => viewModel.selectLtBreakerStatus(value),
              ),
              radioGroupWidget(
                "LT Fuse Set",
                AbSwitch.Available,
                ...
                "Not Available",
                viewModel.ltFuseSet,
                viewModel.isLtFuseSetDisabled,
                (value) => viewModel.selectLtFuseSet(value),
              ),
              radioGroupWidget(
                "LT Fuse Set Status",
                Status.Good,
                ...
                "Good",
                "Damaged",
                viewModel.ltFuseSetStatus,
                viewModel.isLtFuseSetStatusDisabled,
                (value) => viewModel.selectLtFuseSetStatus(value),
              ),
              radioGroupWidget(
                "LT Fuse Wire",
                FuseWire.Copper,
                ...
                "Copper",
                "Aluminium",
                viewModel.ltFuseWire,
                viewModel.isLtFuseWireDisabled,
                (value) => viewModel.selectLtFuseWireStatus(value),
              ),
              radioGroupWidget(
                ...
                "Not Ok",
                viewModel.cfwStatus,
                viewModel.isCfwStatusDisabled,
                (value) => viewModel.selectCfwStatus(value),
              ),
              radioGroupWidget(
                "LT PVC Cable",
                AbSwitch.Available,
                ...
                "Available",
                "Not Available",
                viewModel.ltPvcCable,
                viewModel.isLtPvcCableDisabled,
                (value) => viewModel.selectLtPvcCable(value),
              ),
              radioGroupWidget(
                "LT PVC Cable Status",
                Status.Good,
                ...
                "Good",
                "Damaged",
                viewModel.ltPvcCableStatus,
                viewModel.isLtPvcCableStatusDisabled,
                (value) => viewModel.selectLtPvcCableStatus(value),
              ),
      ...
      return Consumer<DtrHtMaintenanceEntryViewmodel>(
        ...
        return SingleChildScrollView(
            ...
            child:
              ...
              radioGroupWidget(
                "Oil level".toUpperCase(),
                OilLevel.Ok,
                OilLevel.Shortage,
                "OK",
                "Shortage",
                viewModel.oilLevelValue,
                viewModel.isOilLevelDisabled,
                (value) => viewModel.selectOilLevelStatus(value),
              ),
              radioGroupWidget(
                "Oil leakage".toUpperCase(),
                OilLeak.LeakedArrested,
                OilLeak.NotRectified,
                "Leakage Arrested",
                "Not Rectified",
                viewModel.oilLeakValue,
                viewModel.isOilLeakDisabled,
                (value) => viewModel.selectOilLeakStatus(value),
              ),
              radioGroupWidget(
                "Gaskets".toUpperCase(),
                Gaskets.Rectified_Replaced,
                Gaskets.NotRectified,
                "Rectified/Replaced",
                "Not Rectified",
                viewModel.gasketsValue,
                viewModel.isGasketsDisabled,
                (value) => viewModel.selectGasketsStatus(value),
              ),
              radioGroupWidget(
                "Diaphragm".toUpperCase(),
                Gaskets.Rectified_Replaced,
                Gaskets.NotRectified,
                "Rectified/Replaced",
                "Not Rectified",
                viewModel.diaphragm,
                viewModel.isDiaphragmDisabled,
                (value) => viewModel.selectDiaphragm(value),
              ),
              radioGroupWidget(
                "Diaphragm Status".toUpperCase(),
                Status.Good,
                Status.Damaged,
                "Good",
                "Damaged",
                viewModel.diaphragmStatus,
                viewModel.isDiaphragmStatusDisabled,
                (value) => viewModel.selectDiaphragmStatus(value),
              ),
              const Text("Before Maintenance Image"),
              ViewDetailedLcImageWidget(
                  imageUrl: checkNull(viewModel
      ...
      return Consumer<DtrHtMaintenanceEntryViewmodel>(
        ...
        return SingleChildScrollView(
            ...
            child:
                ...
                Row(
                  children: [
                    Radio<EarthPits>(
                      ...
                      onChanged: viewModel.isEarthPitsDisabled
                          ? null
                          : (EarthPits? value) {
                    ...
                    GestureDetector(
                      onTap: viewModel.isEarthPitsDisabled
                          ? null
                          : () {
                              viewModel.selectEarthPitsStatus(EarthPits.one);
                            },
                      child: const Text(
                        "1",
                        style: TextStyle(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: viewModel.isEarthPitsDisabled
                          ? null
                          : () {
                              viewModel.selectEarthPitsStatus(EarthPits.two);
                            },
                      child: const Text(
                        "2",
                        style: TextStyle(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: viewModel.isEarthPitsDisabled
                          ? null
                          : () {
                              viewModel.selectEarthPitsStatus(EarthPits.three);
                            },
                      child: const Text(
                        "3",
                        style: TextStyle(
              ...
              const Divider(),
              radioGroupWidget(
                "Earth pipes".toUpperCase(),
                EarthPipes.GIPipes,
                EarthPipes.CIPipes,
                "GI Pipes",
                "CI Pipes",
                viewModel.earthPips,
                viewModel.isEarthPipsDisabled,
                (value) => viewModel.selectEarthPipsStatus(value),
              ),
              radioGroupWidget(
                "Earth pipes Status".toUpperCase(),
                Gaskets.Rectified,
                Gaskets.NotRectified,
                "Rectified",
                "Not Rectified",
                viewModel.earthPipeStatus,
                viewModel.isEarthPipeStatusDisabled,
                (value) => viewModel.selectEarthPipeStatusStatus(value),
              ),
              radioGroupWidget(
                "Earthing".toUpperCase(),
                Gaskets.Rectified,
                Gaskets.NotRectified,
                "Rectified",
                "Not Rectified",
                viewModel.earthing,
                viewModel.isEarthingDisabled,
                (value) => viewModel.selectEarthingStatus(value),
              ),
              radioGroupWidget(
                "Double Earthing".toUpperCase(),
                AbSwitch.Available,
                AbSwitch.NotAvailable,
                "Available",
                "Not Available",
                viewModel.doubleEarthing,
                viewModel.isDoubleEarthingDisabled,
                (value) => viewModel.selectDoubleEarthingStatus(value),
              ),
              const Text("Before Maintenance Image"),
              ViewDetailedLcImageWidget(
                  imageUrl: checkNull(viewModel
        ...
        return SingleChildScrollView(
            ...
            child:
              ...
              radioGroupWidget(
                ...
                viewModel.isLooseLinesONDtrDisabled,
                (value) => viewModel.selectLooseLinesONDtrStatus(value),
              ),
              radioGroupWidget(
                ...
                viewModel.isLinesTreeCuttingDisabled,
                (value) => viewModel.selectLinesTreeCuttingStatus(value),
              ),
              radioGroupWidget(
                ...
                viewModel.isLineOtherRectDisabled,
                (value) => viewModel.selectLineOtherRectStatus(value),
              ),
              const Text("Before Maintenance Image"),
              ViewDetailedLcImageWidget(
                  imageUrl: checkNull(viewModel
        ...
        return SingleChildScrollView(
          ...
          child:
            ...
            radioGroupWidget(
              ...
              viewModel.isLightingArrestorsDisabled,
              (value) => viewModel.selectLightingArrestorsStatus(value),
            ),
            radioGroupWidget(
              ...
              viewModel.isLightingArrStatusDisabled,
              (value) => viewModel.selectLightingArrStatus(value),
            ),
          ]),
        );
      });
        ...
        return SingleChildScrollView(
            ...
            child:
              ...
              radioGroupWidget(
                ...
                viewModel.isDtrOverLoadedDisabled,
                (value) => viewModel.selectDtrOverLoadedStatus(value),
              ),
            ]));
      });
    ...
    children: [
      Padding(
        padding: const EdgeInsets.only(
            top: 5.0, bottom: 5.0), // use your `doubleFive` if defined
        child: Text(
          title,
