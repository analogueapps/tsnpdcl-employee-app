              ...
              child: structureData.isEmpty
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    onTap: (){
                      viewModel.getStructureData(structure.structureCode!);
                    },
                      child:Padding(
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(structure.structureCode ?? 'N/A',),
                            Text("Land Mark: ${structure.landMark ?? 'N/A'}", style: const TextStyle(fontSize:doubleEleven ),),
                          ],
                        ),
                        const Icon(Icons.arrow_forward_ios, size: doubleSixteen,)
                        ]
                        ),
                        Align(
                          ...
                          child: Text(
                            ...
                            style: const TextStyle(color: Colors.grey, fontSize:doubleEleven),
