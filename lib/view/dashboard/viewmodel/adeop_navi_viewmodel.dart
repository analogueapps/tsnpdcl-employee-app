...
class AdeopNaviViewmodel extends ChangeNotifier {
  ...
  // Toolbar title
  final String _toolbarTitle = "ADE OPN";
  String get toolbarTitle => _toolbarTitle;

  // Constructor to initialize the items
  AdeopNaviViewmodel({required this.context}) {
    _initializeData();
    _initializeItems();
  }
  ...
  void _initializeItems() {
    ...
    _allItems.addAll([
      ...
      UniversalDashboardItem(
        ...
        routeName: Routes.sectionScreen,
      ),
      // UniversalDashboardItem(
