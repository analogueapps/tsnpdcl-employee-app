...
class DtrFailureScreen extends StatelessWidget {
  static const id = Routes.dtrFailureScreen;
  const DtrFailureScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          GlobalConstants.dtrFailureTitle.toUpperCase(),
      ...
      body: ChangeNotifierProvider(
        create: (_) => DtrFailureViewModel(),
        child: Consumer<DtrFailureViewModel>(
          builder: (context, viewModel, child) {
            return viewModel.dtrFailureMenuItems.isNotEmpty
                ? Expanded(
              child: GridView.builder(
                ...
                itemCount: viewModel.dtrFailureMenuItems.length,
                shrinkWrap: true,
