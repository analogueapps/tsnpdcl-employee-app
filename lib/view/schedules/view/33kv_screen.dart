                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    height:
                                        viewModel.abSwitchItems.length * 48.0,
                                  ...
                                  SizedBox(
                                    height:
                                        viewModel.busCouplerItems.length * 48.0,
                                    child: ListView.builder(
                                      physics:
                                          const NeverScrollableScrollPhysics(),
                                      itemCount:
                                          viewModel.busCouplerItems.length,
                                      itemBuilder: (context, index) {
                                        final item =
                                            viewModel.busCouplerItems[index];
                                        return Row(
                                          children: [
                                            Checkbox(
                                              value: item.isChecked,
                                  ...
                                  SizedBox(
                                    height:
                                        viewModel.postTypeItems.length * 48.0,
                                    // Approximate height per item
                                    child: ListView.builder(
                                      physics:
                                          const NeverScrollableScrollPhysics(),
                                  ...
                                  SizedBox(
                                    height:
                                        viewModel.fuseWireItems.length * 48.0,
                                    // Approximate height per item
                                    child: ListView.builder(
                                      physics:
                                          const NeverScrollableScrollPhysics(),
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    height:
                                        viewModel.groupVcbItems.length * 48.0,
                                    // Approximate height per item
                                    child: ListView.builder(
                                      physics:
                                          const NeverScrollableScrollPhysics(),
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    height:
                                        viewModel.KV11busCouplerItems.length *
                                            48.0,
                                    // Approximate height per item
                                    child: ListView.builder(
                                      physics:
                                  ...
                                  SizedBox(
                                    ...
                                    child: ListView.builder(
                                      ...
                                      // Disable inner scrolling
                                      itemCount: viewModel
                                          .busBarConnectorsItems.length,
                                      itemBuilder: (context, index) {
                                        final item = viewModel
                                            .busBarConnectorsItems[index];
                                        return Row(
                                          children: [
                                            Checkbox(
                                              value: item.isChecked,
                                  ...
                                  SizedBox(
                                    height:
                                        viewModel.KV11ctsItems.length * 48.0,
                                    // Approximate height per item
                                    child: ListView.builder(
                                      physics:
                                          const NeverScrollableScrollPhysics(),
                                  ...
                                  SizedBox(
                                    height:
                                        viewModel.KV11vcbItems.length * 48.0,
                                    // Approximate height per item
                                    child: ListView.builder(
                                      physics:
                                          const NeverScrollableScrollPhysics(),
                                  ...
                                  SizedBox(
                                    height: viewModel.fdrABSwitchItems.length *
                                        48.0,
                                    // Approximate height per item
                                    child: ListView.builder(
                                      physics:
                                      ...
                                      // Disable inner scrolling
                                      itemCount:
                                          viewModel.fdrABSwitchItems.length,
                                      itemBuilder: (context, index) {
                                        final item =
                                  ...
                                  SizedBox(
                                    height:
                                        viewModel.KV11ptsItems.length * 48.0,
                                    // Approximate height per item
                                    child: ListView.builder(
                                      physics:
                                          const NeverScrollableScrollPhysics(),
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    height:
                                        viewModel.capacitorBankItems.length *
                                            48.0,
                                    // Approximate height per item
                                    child: ListView.builder(
                                      physics:
                                  ...
                                  SizedBox(
                                    height:
                                        viewModel.stationDtrItems.length * 48.0,
                                    // Approximate height per item
                                    child: ListView.builder(
                                      physics:
                                          const NeverScrollableScrollPhysics(),
                                      // Disable inner scrolling
                                      itemCount:
                                          viewModel.stationDtrItems.length,
                                      itemBuilder: (context, index) {
                                        final item =
                                            viewModel.stationDtrItems[index];
                                        return Row(
                                          children: [
                                            Checkbox(
                                              value: item.isChecked,
                                  ...
                                  SizedBox(
                                    height:
                                        viewModel.ssEarthingItems.length * 48.0,
                                    // Approximate height per item
                                    child: ListView.builder(
                                      physics:
                                          const NeverScrollableScrollPhysics(),
                                      // Disable inner scrolling
                                      itemCount:
                                          viewModel.ssEarthingItems.length,
                                      itemBuilder: (context, index) {
                                        final item =
                                            viewModel.ssEarthingItems[index];
                                        return Row(
                                          children: [
                                            Checkbox(
                                              value: item.isChecked,
                                  ...
                                  SizedBox(
                                    height: viewModel.yardLightingItems.length *
                                        48.0,
                                    // Approximate height per item
                                    child: ListView.builder(
                                      physics:
                                      ...
                                      // Disable inner scrolling
                                      itemCount:
                                          viewModel.yardLightingItems.length,
                                      itemBuilder: (context, index) {
                                        final item =
                                  ...
                                  SizedBox(
                                    height:
                                        viewModel.redHotsItems.length * 48.0,
                                    // Approximate height per item
                                    child: ListView.builder(
                                      physics:
                                          const NeverScrollableScrollPhysics(),
                            ...
                            child: PrimaryButton(
                              onPressed: () {
                                ...
                                if (!viewModel.validateSection(
                                    ...
                                    context)) return;
                                if (!viewModel.validateSection(
                                    viewModel.laItems, "33KV LA(S)", context))
                                  return;
                                if (!viewModel.validateSection(
                                    viewModel.vcbItems, "33KV VCB", context))
                                  return;
                                if (!viewModel.validateSection(
                                ...
                                if (!viewModel.validateSection(
                                    ...
                                    context)) return;
                                if (!viewModel.validateSection(
                                    viewModel.KV11ctsItems,
                                    "11KV CT(S)",
                                    context)) return;
                                if (!viewModel.validateSection(
                                    viewModel.KV11vcbItems,
                                    "11KV VCB",
                                    context)) return;
                                if (!viewModel.validateSection(
