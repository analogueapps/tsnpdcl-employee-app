                  ...
                  children: [
                    ...
                    Text(
                      viewModel.extractMiddlePartRevised(
                          viewModel.selectedHTSC ?? viewModel.htscList[0]),
                        ...
                        Expanded(
                          ...
                          child: DropdownButtonFormField<String>(
                            ...
                            value: viewModel.selectedCTPTRatio != null &&
                                    viewModel.ctptRatios
                                        .contains(viewModel.selectedCTPTRatio)
                                ? viewModel.selectedCTPTRatio
                                : null,
                            items: viewModel.ctptRatios.map((String value) {
                              return DropdownMenuItem<String>(
                                value: value,
                                child: Text(value),
                              );
                    ...
                    Row(
                      children: [
                        const Expanded(
                            flex: 2, child: Text('Year of Manufacturing')),
                        Expanded(
                          flex: 3,
                          child: TextField(
