  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ChangeNotifierProvider(
        ...
        child:
            Consumer<OfflineDtrViewmodel>(builder: (context, viewModel, child) {
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Checkbox(
                                    value:
                                        viewModel.subStationSelectedOffline ==
                                            "SUB STATION",
                                    // Check if it's the selected option
                                    onChanged: (bool? newValue) {
                                      if (newValue == true) {
                                        viewModel.setSelectedSubStationOffline(
                                            "SUB STATION");
                                      } else {
                                        viewModel.setSelectedSubStationOffline(
                                            ""); // or "", depending on how you handle it
                                      }
                                    },
                                  ),
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        DropdownButton<String>(
                                          ...
                                          value: viewModel
                                              .selectedDistributionOffline,
                                          items: viewModel.distributionsOffline
                                          ...
                                          onChanged: (String? value) {
                                            if (value != null) {
                                              final selectedItem = viewModel
                                                  .distributionsOffline
                                                  .firstWhere(
                                                (item) =>
                                                    item.optionCode == value,
                                              );
                                              viewModel
                                                  .onListDistriSelectedOffline(
                                                      value,
                                        ...
                                        DropdownButton<String>(
                                          ...
                                          hint: const Text("Select"),
                                          value:
                                              viewModel.selectedCircleOffline,
                                          items: viewModel.circleOffline
                                              .map<DropdownMenuItem<String>>(
                                                  (Circle item) {
                                            return DropdownMenuItem<String>(
                                              value: item.circleId,
                                        ...
                                        DropdownButton<String>(
                                          ...
                                          items: viewModel.stationOffline
                                              .map<DropdownMenuItem<String>>(
                                        ...
                                        DropdownButton<String>(
                                          ...
                                          hint: const Text("Select"),
                                          value:
                                              viewModel.selectedFeederOffline,
                                          items: viewModel.feederOffline
                                              .map<DropdownMenuItem<String>>(
                                                  (SubstationModel item) {
                                            return DropdownMenuItem<String>(
                                              value: item.optionCode,
                                        ...
                                        DropdownButton<int>(
                                          ...
                                          hint: const Text("Select"),
                                          value:
                                              viewModel.selectedCapacityIndex,
                                          items: viewModel.capacityOffline
                                              .asMap()
                                              .entries
                                        ...
                                        FillTextFormField(
                                          controller:
                                              viewModel.sapDTRStructCodeOffline,
                                          labelText: '',
                                          isReadOnly: true,
                                        ...
                                        FillTextFormField(
                                          controller:
                                              viewModel.dtrLocatLandMarkOffline,
                                          labelText: '',
                                        ...
                                        dropDown(
                                            ...
                                            "DTR Structure Type(*)",
                                            "Select",
                                            viewModel.selectedDTRTypeOffline,
                                            viewModel.dTRtypeOffline,
                                            viewModel
                                                .onListDTRTypeSelectedOffline),
                                        dropDown(
                                            context,
                                            "Plinth Type(*)",
                                            "Select",
                                            viewModel.selectedPlintTypeOffline,
                                            viewModel.plintTypeOffline,
                                            viewModel
                                                .onListPlintTypeSelectedOffline),
                                        dropDown(
                                            context,
                                            "AB Switch",
                                            "Select",
                                            viewModel.selectedABSwitchOffline,
                                            viewModel.aBSwitchOffline,
                                            viewModel
                                                .onListABSwitchSelectedOffline),
                                        dropDown(
                                            context,
                                            "HG Fuse Sets(*)",
                                            "Select",
                                            viewModel.selectedHGFuseOffline,
                                            viewModel.hGFuseOffline,
                                            viewModel
                                                .onListHGFuseSelectedOffline),
                                        dropDown(
                                            context,
                                            "LT Fuse Sets(*)",
                                            "Select",
                                            viewModel.selectedLTFuseSetOffline,
                                            viewModel.lTFuseSetOffline,
                                            viewModel
                                                .onListLTFuseSelectedOffline),
                                        dropDown(
                                            context,
                                            "LT Fuse Type(*)",
                                            "Select",
                                            viewModel.selectedLTFuseTypeOffline,
                                            viewModel.lTTypeOffline,
                                            viewModel
                                                .onListLTFuseTypeSelectedOffline),
                                        dropDown(
                                            context,
                                            "Load Pattern",
                                            "Select",
                                            viewModel
                                                .selectedLoadPatternOffline,
                                            viewModel.loadPatternOffline,
                                            viewModel
                                                .onListLoadPatternSelectedOffline),
                                        Container(
                                          height: 50,
                                          color: Colors.grey[200],
                                          child: Center(
                                        ...
                                        Visibility(
                                          visible: viewModel
                                                      .selectedCapacityOffline !=
                                                  null &&
                                              viewModel.selectedCapacityOffline!
                                                  .isNotEmpty &&
                                              viewModel
                                                      .selectedCapacityOffline !=
                                                  "Select",
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Row(
                                                      children: [
                                                        Expanded(
                                                          // Ensure the dropdown has finite width
                                                          child: dtrDrops(
                                                            "Make",
                                                            viewModel
                                                                .selectedMakeOffline,
                                                    ...
                                                    dtrDrops(
                                                      "Capacity",
                                                      viewModel
                                                          .selectedDtrCapacityOffline,
                                                      viewModel.dtrCapacity,
                                                      viewModel
                                                          .onListDtrCapacityOffline,
                                                    ),
                                                    Row(
                                                      children: [
                                                        SizedBox(
                                                          width:
                                                              150, // Fixed width for all labels
                                                          child: Text(
                                                            "First time DTR\n "
                                                            "Charged/Energised\n Date",
                                                            style: TextStyle(
                                                    ...
                                                    dtrDrops(
                                                      "Year of Mfg",
                                                      viewModel
                                                          .selectedYearOfMfgOffline,
                                                      viewModel.yearOfMfg,
                                                      viewModel
                                                          .onListYearOfMfgOffline,
                                                    ),
                                                    dtrDrops(
                                                      "Phase",
                                                      viewModel
                                                          .selectedPhaseOffline,
                                                      viewModel.phase,
                                                      viewModel
                                                          .onListPhaseOffline,
                                                    ),
                                                    ...
                                                    dtrDrops(
                                                      ...
                                                      "meter (LV side)",
                                                      viewModel
                                                          .selectedTypeOfMeterOffline,
                                                      viewModel.typeOfMeter,
                                                      viewModel
                                                          .onListTypeOfMeterOffline,
                                                    ),
                                                    Row(
                                                      children: [
                                                        SizedBox(
                              ...
                              Visibility(
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      Text(
                                        "Select Physical Location Of DTR",
                                        style: TextStyle(
                                            fontSize: 15,
                                            color: Colors.purple[300]),
                                      ),
                                      DropdownButton<String>(
                                        ...
                                        value:
                                            viewModel.selectedPhysicalLocation,
                                        items: viewModel.listPhysicalLocation
                                            .map((item) {
                                          return DropdownMenuItem<String>(
                                            value: item,
                                            child: Text(item),
