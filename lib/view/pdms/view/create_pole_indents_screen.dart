            ...
            appBar: AppBar(
              ...
              title: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    viewModel.createPoleIndentList.isNotEmpty
                        ? "Showing ${viewModel.createPoleIndentList.length} Indent(s)"
                        : "No Indent(s)",
                    style: const TextStyle(
                          ...
                          return GestureDetector(
                            onTap: () {
                              Navigation.instance.navigateTo(
                                  Routes.viewDetailedPoleIndentScreen,
