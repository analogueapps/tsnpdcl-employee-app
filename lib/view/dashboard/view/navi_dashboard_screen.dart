...
class NaviDashboardScreen extends StatefulWidget {
  ...
  const NaviDashboardScreen({super.key});

  @override
  State<NaviDashboardScreen> createState() => _NaviDashboardScreenState();
}

class _NaviDashboardScreenState extends State<NaviDashboardScreen> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: ChangeNotifierProvider(
        create: (_) => NaviDashboardViewmodel(context: context),
        child: Consumer<NaviDashboardViewmodel>(
