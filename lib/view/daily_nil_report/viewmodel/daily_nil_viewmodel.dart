...
List<EroModel> optionList=[];
  ...
  optionList.add(EroModel(optionId: "1",optionName: "DTR Failure reporting"));
  optionList.add(EroModel(optionId:"15",optionName: "Check Readings"));
  optionList.add(EroModel(optionId:"16",optionName: "Bill stop & UDC inspection"));
  optionList.add(EroModel(optionId:"7",optionName: "33KV Feeder Breakdown reporting"));
  optionList.add(EroModel(optionId:"8",optionName: "11KV Feeder Breakdown reporting"));
  optionList.add(EroModel(optionId:"9",optionName: "Interruptions Entry (33 KV)"));
  optionList.add(EroModel(optionId:"10",optionName: "Interruptions Entry (11KV)"));
  optionList.add(EroModel(optionId:"13",optionName: "Pole Delivery Monitoring System(PDMS)"));
  ...
  optionList.add(EroModel(optionId:"14",optionName: "Pole Tracker (Feeder digitalization)"));
  ...
  optionList.add(EroModel(optionId:"33",optionName: "Inspection of services(RMD exceeded than CMD)"));
  optionList.add(EroModel(optionId:"32",optionName: "Inspection of suspected wrong category"));
  optionList.add(EroModel(optionId:"34",optionName: "Inspection of unpaid II&III category services"));
  optionList.add(EroModel(optionId:"35",optionName: "Inspection of Non-KVAH Services"));
