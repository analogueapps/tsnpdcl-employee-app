  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          "Check Measurement 33kv".toUpperCase(),
      ...
      body: ChangeNotifierProvider(
        ...
        child:
            Consumer<Check33kvViewmodel>(builder: (context, viewModel, child) {
          return Form(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Column(
                              children: viewModel.poleItems
                                ...
                                return checkAndDrop(
                                  ...
                                  (newValue) => viewModel.updatePoleQtyForItem(
                                      newValue, index),
                                );
                              }).toList(),
                            ),
                            ...
                            Column(
                              children: viewModel.poleInsulators
                                ...
                                return checkAndDrop(
                                  ...
                                  item.selectedQty?.toString(),
                                  (newValue) => viewModel.updatePoleInsulators(
                                      newValue, index),
                                );
                              }).toList(),
                            ),
                            ...
                            FillTextFormField(
                                ...
                                labelText: "Particulars of crossing(Optional)",
                                  ...
                                  children: [
                                    ...
                                    DropdownButton<String>(
                                      ...
                                      onChanged: (htServiceName) {
                                        viewModel
                                            .onHtServiceChange(htServiceName);
                                      },
                                    ),
                                  ],
                                )),
