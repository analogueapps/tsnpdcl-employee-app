...
class SchedulesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: Consumer<ScheduleViewModel>(builder: (context, viewModel, child) {
        return Scaffold(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    if (dataIndex != -1) {
                      ...
                      scheduleData = ScheduleData(
                        ...
                        highlightLines:
                            (int.tryParse(dataModel.line) ?? 0) != 0,
                          ...
                          Expanded(
                            ...
                            child: InkWell(
                              child: Container(
                                height: 80,
                                decoration: BoxDecoration(
                                    color: scheduleData.highlightSs
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  border:
                                      Border.all(color: Colors.grey.shade300),
                                  borderRadius: BorderRadius.circular(5),
                                  color: scheduleData.highlightLines
                                      ? Colors.yellow.shade100
                                      : Colors.white,
                                ),
                                padding:
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  border:
                                      Border.all(color: Colors.grey.shade300),
                                  borderRadius: BorderRadius.circular(5),
                                  color: scheduleData.highlightDtr
                                      ? Colors.yellow.shade100
                                      : Colors.white,
                                ),
                                padding:
