...
class LoadChangeRequests extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
        create: (_) =>
            LoadChangeRequestViewmodel(context: context, data: statusData),
            ...
            appBar: AppBar(
              ...
              title: Column(
                  ...
                  children: [
                    ...
                    Text(
                      viewModel.getStatusText(statusData['status']),
            ...
            body: Stack(children: [
                                    ...
                                    IconButton(
                                      onPressed: () {
                                        var arguments = {
                                          ...
                                          'catData': jsonEncode(data.toJson()),
                                        };
                                        Navigation.instance.navigateTo(
                                            Routes.loadChangeDetail,
                                            args: arguments);
                                      },
                                      icon: const Icon(
              ...
              if (viewModel.isLoading)
                Positioned.fill(
                  child: Container(
                    color: Colors.black
                        .withOpacity(0.3), // Optional: dim background
                    child: const Center(
