  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ChangeNotifierProvider(
        ...
        child: Consumer<MapDtrViewMobel>(builder: (context, viewModel, child) {
              ...
              child: Padding(
                ...
                child: Form(
                  ...
                  child: Column(children: [
                    ...
                    Visibility(
                      visible: viewModel.selectedFilter ==
                          "Equipment/Structure search",
                      child: Padding(
                        padding:
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              DropdownButton<String>(
                                ...
                                onChanged: (value) =>
                                    viewModel.onListDistriSelected(value),
                              ),
                            ]),
                      ),
                    ),
                          ...
                          children: [
                            ...
                            DropdownButton<String>(
                              ...
                              items: viewModel.circle
                                  .map<DropdownMenuItem<String>>((Circle item) {
                                return DropdownMenuItem<String>(
                                  value: item.circleId,
                              ...
                              onChanged: (String? value) =>
                                  viewModel.onListCircleSelected(value),
                            ),
                            ...
                            DropdownButton<String>(
                              ...
                              items:
                                  viewModel.feeder.map((SubstationModel item) {
                                return DropdownMenuItem<String>(
                                  value: item.optionCode,
                                  child: Text(item.optionName),
                                );
                              ...
                              onChanged: (value) => viewModel
                                  .onListFeederSelected(value), // Fixed
                            ),
                          ],
                        ),
                      ),
