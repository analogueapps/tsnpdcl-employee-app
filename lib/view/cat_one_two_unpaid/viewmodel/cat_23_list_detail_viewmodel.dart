...
class Cat23ListDetailViewmodel extends ChangeNotifier {
  Cat23ListDetailViewmodel({required this.context, required this.args}) {
    print("Cat23ListDetailViewmodel args: $args");
    // catListDetail.add()
  }
  ...
  List<CatInspectionModel>  catListDetail=[];
