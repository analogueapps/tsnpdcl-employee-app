...
class CCCViewDetailed extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
        ...
        child: Consumer<OpenViewmodel>(builder: (context, viewModel, child) {
          return Scaffold(
            appBar: AppBar(
              ...
              actions: [
                IconButton(
                    onPressed: () {
                      Navigation.instance.navigateTo(Routes.complaintTrack,
                          args: data.ticketNumber);
                    },
                    icon: const Icon(
                      Icons.history,
                      color: Colors.white,
                          ...
                          child: Column(
                            children: [
                              ...
                              ViewDetailedLcTileWidget(
                                  ...
                                  tileValue: data.complaintSubType ?? ""),
                              ViewDetailedLcTileWidget(
                                  tileKey: "USCNO",
                                  tileValue: data.uscNo ?? ""),
                              ViewDetailedLcTileWidget(
                                  tileKey: "SC No", tileValue: data.scNo ?? ""),
                              ViewDetailedLcTileWidget(
                              ...
                              ViewDetailedLcTileWidget(
                                  tileKey: "H.No", tileValue: data.hNo ?? ""),
                              ViewDetailedLcTileWidget(
                                  tileKey: "Address",
