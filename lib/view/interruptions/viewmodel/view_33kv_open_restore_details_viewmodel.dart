...
class View33kvOpenRestoreDetailsViewmodel extends ChangeNotifier {
  late String substation;
  late String feeder;
  late String breakdownStartTime;
  late int noOfSSAffected;
  late int reportId;
  ...
  View33kvOpenRestoreDetailsViewmodel(Map<String, dynamic> data) {
    substation = data['ssName'];
    feeder = data['feederName'];
    breakdownStartTime = "${data['startDate']}, ${data['startTime']}";
    noOfSSAffected = data['noOfSSAffected'];
