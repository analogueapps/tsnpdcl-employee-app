...
class DetailedView11kvBreakdownScreen extends StatelessWidget {
  static const id = Routes.detailedView11kvBreakdownScreen;
  final Map<String, dynamic> data;

  const DetailedView11kvBreakdownScreen({super.key, required this.data});
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(children: [
          ...
          const Divider(),
          ViewDetailedLcTileWidget(
              tileKey: "NO OF VILLAGES AFFECTED",
              tileValue: data['noOfVillagesAffected'].toString()),
          const Divider(),
          ...
          Visibility(
              ...
              child: Padding(
                ...
                child: PrimaryButton(
                    ...
                    fullWidth: isTrue,
                    onPressed: () {
                      Navigation.instance.navigateTo(Routes.view11kvOpenRestoreDetails, args: data);
                    }),
              ))
        ]),
      ),
