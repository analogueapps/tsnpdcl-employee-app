...
import 'package:tsnpdcl_employee/view/interruptions/viewmodel/view_11kv_open_restore_details_viewmodel.dart';
import 'package:tsnpdcl_employee/widget/primary_button.dart';
import 'package:tsnpdcl_employee/widget/fill_text_form_field.dart';

class View11kvOpenRestoreDetails extends StatelessWidget {
  static const id = Routes.view11kvOpenRestoreDetails;
  final Map<String, dynamic> data;

  const View11kvOpenRestoreDetails({super.key, required this.data});

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => View11kvOpenRestoreDetailsViewmodel(data),
      child: Scaffold(
        appBar: AppBar(
        ...
        body: Consumer<View11kvOpenRestoreDetailsViewmodel>(
            ...
            return SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  FillTextFormField(
                    controller: TextEditingController(text: viewModel.noOfVillagesAffected.toString()),
                    labelText: "NO OF VILLAGES AFFECTED",
  ...
  Widget _buildDateTimeField(
      String label, String date, View11kvOpenRestoreDetailsViewmodel viewModel, BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
  ...
  Widget _buildDropdown(String label, String value, View11kvOpenRestoreDetailsViewmodel viewModel) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(label, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w500)),
  ...
  Widget _buildCheckbox(String label, List<String> options, View11kvOpenRestoreDetailsViewmodel viewModel) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(label, style: const TextStyle(fontSize: 16)),
  ...
  Widget _buildRadioButtons(View11kvOpenRestoreDetailsViewmodel viewModel) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
  ...
  Widget _buildRadioOption(String label, View11kvOpenRestoreDetailsViewmodel viewModel) {
    return Expanded(
      child: Row(
        children: [
          Radio<String>(
