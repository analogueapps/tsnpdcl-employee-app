...
class BsUdcList extends StatelessWidget {
  const BsUdcList({super.key});
  static const id = Routes.bsUdcInspectionList;

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) =>
          CheckReadingViewModel(context: context, bsudcScreen: "Yes"),
      child:
          Consumer<CheckReadingViewModel>(builder: (context, viewModel, child) {
        return Scaffold(
          appBar: AppBar(
            title: const Text(
              'BS/UDC Inspected List',
              style: TextStyle(
                color: Colors.white,
                fontSize: 20,
          ...
          floatingActionButton: FloatingActionButton(
            ...
            onPressed: () {
              Navigation.instance
                  .navigateTo(Routes.enterServicesScreen, args: true);
            },
