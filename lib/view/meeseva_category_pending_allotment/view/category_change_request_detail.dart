...
class CategoryChangeRequestDetail extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
        create: (_) =>
            CategoryChangeDetailViewmodel(context: context, data: data),
                          ...
                          child: Column(
                            children: [
                              ViewDetailedLcTileWidget(
                                  ...
                                  tileValue:
                                      "${viewModel.categoryChange.regId}"),
                              ViewDetailedLcTileWidget(
                              ...
                              ViewDetailedLcTileWidget(
                                  tileKey: "USCNO",
                                  tileValue: viewModel.categoryChange.uscno
                                      .toString()),
                              ViewDetailedLcTileWidget(
                                  tileKey: "SCNO",
                              ...
                              ViewDetailedLcTileWidget(
                                  ...
                                  tileValue:
                                      viewModel.categoryChange.existCat ?? ""),
                              ViewDetailedLcTileWidget(
                                  tileKey: "Existing load".toUpperCase(),
                                  tileValue: viewModel.categoryChange.existLoad
                                      .toString()),
                              const ViewDetailedLcHeadWidget(
                              ...
                              ViewDetailedLcTileWidget(
                                  ...
                                  tileValue:
                                      viewModel.categoryChange.reqCat ?? ""),
                              ViewDetailedLcTileWidget(
                                  tileKey: "modification type".toUpperCase(),
                                  tileValue: viewModel
                                          .categoryChange.serviceChangeType ??
                                      ""),
                              const ViewDetailedLcHeadWidget(
                              ...
                              ViewDetailedLcTileWidget(
                                  ...
                                  tileValue:
                                      viewModel.categoryChange.distribution ??
                                          "null"),
                              ViewDetailedLcTileWidget(
                                  tileKey: "applied ny name".toUpperCase(),
                                  tileValue:
                                      viewModel.categoryChange.informatName ??
                                          ""),
                              ViewDetailedLcTileWidget(
                                  tileKey: "door no".toUpperCase(),
                                  tileValue:
                                      viewModel.categoryChange.doorNo ?? ""),
                              ViewDetailedLcTileWidget(
                                  tileKey: "street".toUpperCase(),
                                  tileValue:
                                      viewModel.categoryChange.street ?? ""),
                              ViewDetailedLcTileWidget(
                                  tileKey: "area".toUpperCase(),
                                  tileValue:
                                      viewModel.categoryChange.area ?? "null"),
                              ViewDetailedLcTileWidget(
                                  tileKey: "town".toUpperCase(),
                                  tileValue:
                                      viewModel.categoryChange.town ?? ""),
                              ViewDetailedLcTileWidget(
                                  tileKey: "mobile".toUpperCase(),
                                  tileValue: viewModel.categoryChange.mobile
                                          .toString() ??
                                      ""),
                              ViewDetailedLcTileWidget(
                                  tileKey: "phone".toUpperCase(),
                                  tileValue: viewModel.categoryChange.phoneNo ??
                                      "null"),
                              ViewDetailedLcTileWidget(
                                  tileKey: "email".toUpperCase(),
                                  tileValue:
                                      viewModel.categoryChange.email ?? "null"),
                              const ViewDetailedLcHeadWidget(
                                title: "Staff Details",
                              ),
                              ViewDetailedLcTileWidget(
                                  tileKey: "status".toUpperCase(),
                                  tileValue: viewModel.categoryChange.status ??
                                      "null"),
                              ViewDetailedLcTileWidget(
                                  tileKey: "status date".toUpperCase(),
                                  tileValue:
                                      viewModel.categoryChange.statusDate ??
                                          "null"),
                              ViewDetailedLcTileWidget(
                                  tileKey: "ae employee id".toUpperCase(),
                                  tileValue: viewModel.categoryChange.aeEmpId ??
                                      "null"),
                              ViewDetailedLcTileWidget(
                                  tileKey: "staff employee id".toUpperCase(),
                                  tileValue: viewModel.categoryChange.lmEmpId ??
                                      "null"),
                              ViewDetailedLcTileWidget(
                                  tileKey: "reason".toUpperCase(),
                                  tileValue: viewModel.categoryChange.reason ??
                                      "null"),
                              ViewDetailedLcTileWidget(
                                  tileKey: "EBS reason".toUpperCase(),
                                  tileValue:
                                      viewModel.categoryChange.ebsRemarks ??
                                          "null"),
                              ViewDetailedLcTileWidget(
                                  tileKey: "EBS status".toUpperCase(),
                                  tileValue:
                                      viewModel.categoryChange.ebsStatus ??
                                          "null"),
                              ViewDetailedLcTileWidget(
                                  tileKey: "EBS date".toUpperCase(),
                                  tileValue: viewModel.categoryChange.ebsDate ??
                                      "null"),
                              const ViewDetailedLcHeadWidget(
                              ...
                              ViewDetailedLcTileWidget(
                                  ...
                                  tileValue:
                                      viewModel.categoryChange.meterMake ??
                                          "null"),
                              ViewDetailedLcTileWidget(
                                  tileKey: "meter capacity".toUpperCase(),
                                  tileValue:
                                      viewModel.categoryChange.meterCapacity ??
                                          "null"),
                              ViewDetailedLcTileWidget(
                                  tileKey: "meter serial No".toUpperCase(),
                                  tileValue:
                                      viewModel.categoryChange.meterSlNo ??
                                          "null"),
                              ViewDetailedLcTileWidget(
                                  tileKey: "meter final reading".toUpperCase(),
                                  tileValue: viewModel.categoryChange.meterFr
                                          .toString() ??
                                      "null"),
                              Text("Test Report".toUpperCase()),
                              ViewDetailedLcImageWidget(
                                  imageUrl:
                                      viewModel.categoryChange.testReportPath ??
                                          ""),
