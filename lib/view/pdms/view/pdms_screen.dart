...
import 'package:tsnpdcl_employee/view/pdms/viewmodel/pdms_viewmodel.dart';

class PdmsScreen extends StatelessWidget {
  static const id = Routes.pdmsScreen;
  const PdmsScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          GlobalConstants.pdmsTitle.toUpperCase(),
      ...
      body: ChangeNotifierProvider(
        create: (_) => PdmsViewModel(),
        child: Consumer<PdmsViewModel>(
          builder: (context, viewModel, child) {
            return viewModel.pdmsMenuItems.isNotEmpty
                ? GridView.builder(
              ...
              itemCount: viewModel.pdmsMenuItems.length,
              shrinkWrap: true,
