...
class Apis {
  ...
  /// IMAGE
  static const NPDCL_STORAGE_SERVER_IP =
      "http://210.212.223.83:7000/NpdclFileStorageWebApi/";

  ///IMAGE UPLOAD URL
  static const IMAGE_UPLOAD_URL =
      "$ROOT_URL/NpdclFileStorageWebApi/tsnpdcl/fd/api/imr";
  ...
  ///Asset Mapping
  static const ROOT_URL_ASSET_MAPPING =
      "http://210.212.223.88:5656/NPFDAS/ep/asset/";
  static const ASSET_MAPPING_URL = "/map";

  ///CHECK READING ROOT DOMAIN * BHAVANA
  static const CHECK_ROOT_URL =
      "http://210.212.223.87:8181/NPDCL2019WebApi/rest/";
  ...
  static const GET_INDUCTION_POINTS_OF_FEEDER_URL =
      "getInductionPointsOfFeeder";
  ...
  static const GET_MIDDLE_POLES_BAR_GRAPH_DATA_URL =
      "getMiddlePolesBarGraphData";
  static const GET_MAINTENANCE_BAR_GRAPH_DATA_URL =
      "getMaintenanceBarGraphData";
  ...
  static const GET_DTR_INSPECTIONS_FILTER_DATA_URL =
      "getDtrInspectionsFilterData";
  static const GET_FILTERED_DTR_INSPECTIONS_DATA_URL =
      "getFilteredDtrInspections";
  ...
  static const INTERRUPTIONS_END_POINT_BASE_URL =
      "$SERVER_IP:5656/NPFDAS/ep/interruptions/";

  /// 33KV BREAKDOWN ENTRY * DROPDOWN FIELDS
  static const GET_132KV_SUBSTATIONS_OF_SECTION =
      "get132kvSubstationsOfSection";
  ...
  static const SS_MAINTENANCE_WEB_URL =
      "$SERVER_IP:5656/NPFDAS/SSMaintenanceView?iid=";
  ...
  static String CHECK_BS_UDC_IP_PORT = SERVER_IP.startsWith("http://192.168.30")
      ? "http://10.100.4.58:7000"
      : "http://210.212.223.83:7000";
  static String CHECK_BS_UDC_WED_URL =
      "$CHECK_BS_UDC_IP_PORT/NpdclEmployeeWebApi/";

  ///ONLINE PR * BHAVANA
  static const ONLINE_PR_END_POINT_BASE_URL =
      "$SERVER_IP:5656/NPFDAS/ep/onlinePr/";
  ...
  ///Exceptionals
  static String IP_PORT_METER_MAKE = SERVER_IP.startsWith("http://192.168.30")
      ? "http://10.100.4.58:7000"
      : "http://210.212.223.83:7000";
  static const METER_MAKE = "/NpdclEmployeeWebApi/npemp/api";
  static String METER_CHANGE =
      "http://10.100.4.58:7000/NpdclEmployeeWebApi/npemp/api";
  ...
  static const CAT_CHANGE_ENDPOINT_URL =
      "$SERVER_IP:5656/NPFDAS/ep/cat-change/";
  ...
  static const MEE_SEVA_MODIFY_SEVICE_DOCUMENTS_URL =
      "http://210.212.223.83:7000/J2S/j2s//nc/Reports/MSDDocumentsView.jsp?xregNum=";

  //Meeseva -> Load Change
  static const LOAD_CHANGE_REQUEST_URL =
      "$SERVER_IP:5656/NPFDAS/ep/load-change/";
  static const LOAD_CHANGE_REQUEST_OF_SECTION =
      "getLoadChangeRequestsOfSection";
  ...
  ///ROUTE FROM CCC
  static const ERO_CORRESPONDENCE_URL =
  ...
  static const NAME_AND_ADDRESS_CORRECTION_REQUEST =
      "getNameAndAddressCorrectionRequests";
