  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ChangeNotifierProvider(
        create: (_) =>
            SsMaintenanceViewModel(context: context), // Use ViewModel
                        ...
                        onTap: () {
                          if (item.title == "Inspect SS") {
                            showAlertDialog(context,
                                "Please use Schedules menu to inspect the substations. Substations need to be scheduled by ADE/OP for maintenance");
                          } else {
                            viewModel.menuItemClicked(
                                item.title, item.routeName);
