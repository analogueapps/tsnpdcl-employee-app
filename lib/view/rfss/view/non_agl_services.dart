...
class NonAglServices extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: Consumer<NonAglViewModel>(builder: (context, viewModel, child) {
        return Scaffold(
          appBar: AppBar(
                    ...
                    Column(
                        ...
                        children: [
                            ...
                            child: Column(
                                ...
                                children: [
                                  ...
                                  DropdownButton<String>(
                                    ...
                                    items:
                                        viewModel.distributionList.map((item) {
                                    ...
                                    onChanged: viewModel
                                            .distributionList.isNotEmpty
                                        ? (value) => viewModel
                                            .onListDistributionSelected(value)
                                        : null,
                                  ),
                                ]),
                          ),
                          Center(
                            child: TextButton(
                              onPressed: () {
                                viewModel.nonAGLUnmappedServices(
                                    viewModel.selectedDistribution ?? "");
                              },
                              style: ButtonStyle(
                                backgroundColor:
                          ...
                          TextFormField(
                            ...
                            controller: TextEditingController(
                                text: viewModel.selectedStructure ?? ''),
                            onTap: () => viewModel
                                .showSearchableStructureDialog(context),
                          ...
                          Container(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                final service =
                                    viewModel.unmappedServices[index];
                                return Padding(
                                  padding: const EdgeInsets.all(16.0),
                                  child: Row(
                                    mainAxisAlignment:
                                    ...
                                    children: [
                                      Checkbox(
                                        value:
                                            viewModel.isChecked(service.uscno),
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            Text(service.name),
                                            Text(
                                                " ${service.uscno} | ${service.scno}"),
                                            Align(
                                              alignment: Alignment.bottomRight,
                                              child:
                                                  Text("Cat: ${service.cat}"),
                                            ),
                                            if (viewModel
                                                    .isChecked(service.uscno) &&
                                                viewModel.selectedStructure !=
                                                    null)
                                              Text(
                                                " ${viewModel.selectedStructure}",
