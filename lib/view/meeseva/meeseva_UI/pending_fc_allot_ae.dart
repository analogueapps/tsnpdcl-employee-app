...
class IntimatedToConsumerList extends StatefulWidget {
  @override
  State<IntimatedToConsumerList> createState() => _IntimatedToConsumerListState();

  final String title;

  IntimatedToConsumerList({required this.title});
                ...
                return Column(
                  children: [
                    ListTile(
                      ...
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>SearchApplication(regNo: '${consumer.id}',)));
                      },
                    ),
                    Padding(
