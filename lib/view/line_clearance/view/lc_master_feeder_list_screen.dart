    ...
    return Scaffold(
      ...
      body: ChangeNotifierProvider(
        create: (_) => LcMasterViewmodel(
            context: context,
            entry: "LcMasterFeederListScreen",
            ssCode: args['ssCode']),
          ...
          builder: (context, viewModel, child) {
            return viewModel.isLoading
                ...
                : viewModel.lcMasterFeederList.isEmpty
                    ? const Center(
                        child: Text("No Feeder List Section founded."),
                      )
                    : ListView.separated(
                        ...
                        itemBuilder: (_, int index) => ListTile(
                          ...
                          onTap: () {
                            var argument = {
                              ...
                              'ssName': args['ssName'],
                              'fdrCode':
                                  viewModel.lcMasterFeederList[index].optionId!,
                              'fdrName': viewModel
                                  .lcMasterFeederList[index].optionName!,
                            };
                            Navigation.instance.navigateTo(
                                Routes.feederInductionListScreen,
                                args: argument);
                          },
                        ),
