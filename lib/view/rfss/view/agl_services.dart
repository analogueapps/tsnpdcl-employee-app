            ...
            Column(
                ...
                children: [
                  ...
                  Align(
                      ...
                      child: const Text("DOWNLOAD OTHER SECTION DTRS",style: const TextStyle(color: Colors.white),)
                  ),
                  ),
                  const SizedBox(height: 5,),
                  ...
                  SizedBox(height: 20,),
                  const Center(child:Text("GPS CO-ORDINATES",),),
                 SizedBox(
                    height: doubleSixty,
                    child:viewModel.longitude!=null &&viewModel.latitude!=null
                        ?
                    Column(
                      children: [
                        Text("LAT:${viewModel.latitude}", style: const TextStyle(color: Colors.grey),),
                        Text("LON:${viewModel.longitude}", style: const TextStyle(color: Colors.grey),),
                      ],
