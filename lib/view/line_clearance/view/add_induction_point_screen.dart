                ...
                children: [
                  ...
                  CheckboxListTile(
                    ...
                    title: const Text(
                      "NO INDUCTION SOURCE",
                      style: TextStyle(
                          fontSize: normalSize, fontWeight: FontWeight.w500),
                    ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        DropdownButton<String>(
                          ...
                          onChanged: (value) {
                            viewModel
                                .onList33KvFeederOf132kVssValueChange(value);
                          },
                        ),
                      ],
                    ),
                  ...
                  Visibility(
                    visible: viewModel.isSelected("11KV LINE") ||
                        viewModel.isSelected("LT LINE"),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const SizedBox(height: doubleTen),
