...
class ViewDispatchInstructionsViewModel extends ChangeNotifier {
  ...
  final List<PoleDispatchInstructionsEntity> _poleDispatchInstructionList = [];
  List<PoleDispatchInstructionsEntity> get poleDispatchInstructionList => _poleDispatchInstructionList;

  // Filter list
  final List<FilterLabelModelList> filterLabelModelList = [];

  // Constructor to initialize the items
  ViewDispatchInstructionsViewModel({required this.context}) {
    _loadUser();
    getDisOfStatus();
  }
  ...
  Future<void> getDisOfStatus() async {
    ...
    var response = await ApiProvider(baseUrl: Apis.PDMS_END_POINT_BASE_URL).postApiCall(context, Apis.GET_DIS_OF_STATUS_URL, payload);
    _isLoading = isFalse;
  ...
  Future<void> getFilterData() async {
    ...
    var response = await ApiProvider(baseUrl: Apis.PDMS_END_POINT_BASE_URL).postApiCall(context, Apis.GET_DIS_FILTER_DATA_URL, payload);
    if (context.mounted) {
