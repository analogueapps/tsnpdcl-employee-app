                    ...
                    child:Column(
                          ...
                          children: [
                            ...
                            CheckboxListTile(
                              ...
                              title: const Column(
                                ...
                                children: [
                                  ...
                                  Text.rich(
                                    TextSpan(
                                      text: 'Choose this option if you want to continue with the existing session',
                                      style: TextStyle(fontSize: extraRegularSize),
                                    ),
                                  ),
                                ],
                            ...
                            TextFormField(
                              maxLines: null,
                              minLines: 5,
                              readOnly:  viewModel.selectedPurposeCheckboxId=="NCMD"? false: true,
                            ...
                            const SizedBox(height: 20,),
                            SizedBox(width: double.infinity,child:PrimaryButton(text: "PROCEED",
                                onPressed: (){
                                      viewModel.proceed();
                            }),),
                            const SizedBox(height: 20,),
