                        ...
                        child: Column(
                          children: [
                            ViewDetailedLcTileWidget(
                                tileKey: "SCHEDULE ID", tileValue: "${data.tourId}"),
                              ...
                              child:PrimaryButton(
                                  ...
                                  onPressed: () {
                                    if(data.type=="SS") {
                                      ...
                                      Navigation.instance.navigateTo(Routes.dtrMaintenanceScreen);
                                    }
                                  }),
                            ),
                            const SizedBox(height: 10,),
                            ViewDetailedLcTileWidget(
                                tileKey: "SCHEDULED MONTH", tileValue: data.scheduledMonth),
                            ViewDetailedLcTileWidget(
                                tileKey: "CIRCLE",
                            ...
                            ViewDetailedLcTileWidget(
                                tileKey: "DE EMP ID", tileValue: data.deEmpId??"NULL"),

                            ViewDetailedLcTileWidget(
                                tileKey: "DE EMP NAME", tileValue: data.deEmpName??"NULL"),
