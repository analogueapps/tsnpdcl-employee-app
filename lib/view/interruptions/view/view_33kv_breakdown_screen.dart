...
import 'package:tsnpdcl_employee/view/interruptions/viewmodel/view_33kv_breakdown_viewmodel.dart';
...
class View33kvBreakdownScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => View33kvBreakdownViewmodel(context: context),
      child: Consumer<View33kvBreakdownViewmodel>(
                                  ...
                                  return InkWell(
                                    onTap: () {
                                      Navigation.instance.navigateTo(
                                        Routes.detailedView33kvBreakdownScreen,
