...
import 'package:tsnpdcl_employee/view/dashboard/viewmodel/adeop_navi_viewmodel.dart';
...
class AdeopNaviScreen extends StatefulWidget {
  static const id = Routes.adeopNaviScreen;
  const AdeopNaviScreen({super.key});

  @override
  State<AdeopNaviScreen> createState() => _AdeopNaviScreenState();
}

class _AdeopNaviScreenState extends State<AdeopNaviScreen> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: ChangeNotifierProvider(
        create: (_) => AdeopNaviViewmodel(context: context),
        child: Consumer<AdeopNaviViewmodel>(
                  ...
                  Material(
                    ...
                    child: Padding(
                      ...
                      child: TextField(
                        ...
                        onChanged: (query) {
                          Provider.of<AdeopNaviViewmodel>(context,
                              listen: false)
                              .filterItems(query);
                        },
                            ...
                            suffixIcon: GestureDetector(
                              onTap: () {
                                if (viewModel.searchController.text.isNotEmpty) {
                                  ...
                                  Provider.of<AdeopNaviViewmodel>(
                                      context,
                                      listen: false)
                                      .filterItems("");
                                }
