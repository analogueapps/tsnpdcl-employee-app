...
class AllLcRequestListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) =>
          AllLcRequestListViewModel(context: context, status: status),
            ...
            appBar: AppBar(
              ...
              title: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    viewModel.allLcRequestList.isNotEmpty
                        ? "Showing ${viewModel.allLcRequestList.length} Lc(s)"
                        : "No Ls(s)",
                    style: const TextStyle(
