...
class SuppressedMonthWiseViewmodel extends ChangeNotifier {
  SuppressedMonthWiseViewmodel({required this.context, required this.args}) {
    print(" args: $args");
  ...
  Future<void> _loadAbstractBasedOnMonthYear(
    ...
    try {
      final response = await ApiProvider(baseUrl: Apis.SUPPRESSED_INSPECTION_URL)
