                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                            ...
                            child: Column(
                              children: [
                                ...
                                TextField(
                                  ...
                                  readOnly: true,
                                  onTap: () =>
                                      viewModel.disconnectionDateClicked(),
                            ...
                            children: [
                              Expanded(
                                child: CheckboxListTile(
                                  ...
                                  value:
                                      viewModel.isSelected("Full Amount Paid"),
                                  onChanged: (value) {
                                    viewModel
                                        .selectCheckbox("Full Amount Paid");
                                  },
                                ),
                              ),
                              Expanded(
                                child: CheckboxListTile(
                                  ...
                                  value:
                                      viewModel.isSelected("Part Amount Paid"),
                                  onChanged: (value) {
                                    viewModel
                                        .selectCheckbox("Part Amount Paid");
                                  },
                                ),
                              ),
                            ],
                          ...
                          Visibility(
                            visible: viewModel.isSelected("Full Amount Paid") ||
                                viewModel.isSelected("Part Amount Paid"),
                            child: Column(
                              children: [
                                FillTextFormField(
                  ...
                  Card(
                      ...
                      child: Column(
                        children: [
                          ...
                          DlistAttendTileWidget(
                              tileKey: "Area",
                              tileValue: checkNull(
                                  viewModel.dlistEntityRealmList!.areaname)),
                          DlistAttendTileWidget(
                              tileKey: "Arrears(₹)",
                              tileValue: checkNull(viewModel
                                  .dlistEntityRealmList!.arrears
                                  .toString())),
                          DlistAttendTileWidget(
                              tileKey: "Address",
                              tileValue: checkNull(
                                  viewModel.dlistEntityRealmList!.ctadd2)),
                          DlistAttendTileWidget(
                              tileKey: "Area Code",
                              tileValue: checkNull(
                                  viewModel.dlistEntityRealmList!.ctareacd)),
                          DlistAttendTileWidget(
                              tileKey: "Consumer Name",
                              tileValue: checkNull(
                                  viewModel.dlistEntityRealmList!.ctname)),
                          DlistAttendTileWidget(
                              tileKey: "Phone",
                              tileValue: checkNull(viewModel
                                  .dlistEntityRealmList!.ctphone
                                  .toString())),
                          DlistAttendTileWidget(
                              tileKey: "Pole No",
                              tileValue: checkNull(
                                  viewModel.dlistEntityRealmList!.ctpoleno)),
                          DlistAttendTileWidget(
                              tileKey: "Social Group",
                              tileValue: checkNull(viewModel
                                  .dlistEntityRealmList!.ctsocialgroup)),
                          DlistAttendTileWidget(
                              tileKey: "Current Month Demand(₹)",
                              tileValue: checkNull(viewModel
                                  .dlistEntityRealmList!.curdem
                                  .toString())),
                          DlistAttendTileWidget(
                              tileKey: "Disc. Date",
                              tileValue: checkNull(
                                  viewModel.dlistEntityRealmList!.discdt)),
                          DlistAttendTileWidget(
                              tileKey: "Amount(₹)",
                              tileValue: checkNull(viewModel
                                  .dlistEntityRealmList!.dlamt
                                  .toString())),
                          DlistAttendTileWidget(
                              tileKey: "Cat",
                              tileValue: checkNull(viewModel
                                  .dlistEntityRealmList!.dlcat
                                  .toString())),
                          DlistAttendTileWidget(
                              tileKey: "DList Type",
                              tileValue: checkNull(
                                  viewModel.dlistEntityRealmList!.type)),
                          DlistAttendTileWidget(
                              tileKey: "Month Year",
                              tileValue: checkNull(
                                  viewModel.dlistEntityRealmList!.dlmonyr)),
                          DlistAttendTileWidget(
                              tileKey: "SC No",
                              tileValue: checkNull(
                                  viewModel.dlistEntityRealmList!.dlscno)),
                          DlistAttendTileWidget(
                              tileKey: "Status",
                              tileValue: checkNull(
                                  viewModel.dlistEntityRealmList!.dlstat)),
                          DlistAttendTileWidget(
                              tileKey: "USCNO",
                              tileValue: checkNull(viewModel
                                  .dlistEntityRealmList!.dluan
                                  .toString())),
                          const DlistAttendTileWidget(
                              tileKey: "Attended By", tileValue: "-"),
                          DlistAttendTileWidget(
                              tileKey: "ERO Code",
                              tileValue: checkNull(viewModel
                                  .dlistEntityRealmList!.erocode
                                  .toString())),
                          DlistAttendTileWidget(
                              tileKey: "Section",
                              tileValue: checkNull(
                                  viewModel.dlistEntityRealmList!.j2SSection)),
                          DlistAttendTileWidget(
                              tileKey: "Last Paid Date",
                              tileValue: checkNull(
                                  viewModel.dlistEntityRealmList!.lastpddt)),
                          DlistAttendTileWidget(
                              tileKey: "Section",
                              tileValue: checkNull(
                                  viewModel.dlistEntityRealmList!.secname)),
                          const SizedBox(
                            height: doubleTen,
                          ),
                        ],
