            ...
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Center(
                    child: Visibility(
                      visible: viewModel.pointALat != null &&
                          viewModel.pointBLat != null,
                      child: Text(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        if (viewModel.pointALat == null) {
                          viewModel
                              .capturePointA(); // Capture Point A if it doesn't exist
                        } else {
                          viewModel
                              .capturePointB(); // Capture Point B if Point A exists
                        }
                      },
