              ...
              return Scaffold(
                appBar: AppBar(
                  ...
                  actions:  [IconButton(onPressed: ()async{
                    final Uri url = Uri.parse(Apis.MEE_SEVA_MODIFY_SEVICE_DOCUMENTS_URL+viewModel.loadChange.regNum);
                        ...
                        child: Column(
                          children: [
                            ViewDetailedLcTileWidget(
                                tileKey: "reg Id".toUpperCase(), tileValue: "${viewModel.loadChange.regId}"),
                            ...
                            ViewDetailedLcTileWidget(
                                tileKey: "USCNO",
                                tileValue: viewModel.loadChange.uscno.toString()),
                            ViewDetailedLcTileWidget(
                                tileKey: "SCNO",
                                tileValue: viewModel.loadChange.scno),
                            const ViewDetailedLcHeadWidget(title: "Existing Details",),
                            ViewDetailedLcTileWidget(
                                tileKey: "consumer name".toUpperCase(), tileValue: viewModel.loadChange.consumerName??""),
                            ViewDetailedLcTileWidget(
                                tileKey: "existing category".toUpperCase(),
                                tileValue: viewModel.loadChange.existCat??""),
                            ViewDetailedLcTileWidget(
                                tileKey: "Existing load".toUpperCase(),
                                tileValue: viewModel.loadChange.existLoad.toString()),
                            ...
                            ViewDetailedLcTileWidget(
                                ...
                                tileValue: viewModel.loadChange.serviceChangeType??""),
                            ViewDetailedLcTileWidget(
                                tileKey: "requested load".toUpperCase(),
                                tileValue: viewModel.loadChange.reqLoad.toString()),
                            const ViewDetailedLcHeadWidget(title: "address details",),
                            ViewDetailedLcTileWidget(
                                tileKey: "distribution".toUpperCase(),
                                tileValue: viewModel.loadChange.distribution??"null"),

                            ViewDetailedLcTileWidget(
                                tileKey: "applied ny name".toUpperCase(),
                                tileValue: viewModel.loadChange.informatName??""),
                            ...
                            ViewDetailedLcTileWidget(
                                ...
                                tileValue: viewModel.loadChange.area??"null"),
                            ViewDetailedLcTileWidget(
                                tileKey: "town".toUpperCase(),
                                tileValue: viewModel.loadChange.town??""),
                            ViewDetailedLcTileWidget(
                                tileKey: "mobile".toUpperCase(),
                                tileValue: viewModel.loadChange.mobile.toString()??""),
                            ViewDetailedLcTileWidget(
                                tileKey: "phone".toUpperCase(),
                                tileValue: viewModel.loadChange.phoneNo??"null"),
                            ViewDetailedLcTileWidget(
                                tileKey: "email".toUpperCase(),
                                tileValue: viewModel.loadChange.email??"null"),
                            const ViewDetailedLcHeadWidget(title: "Staff Details",),
                            ViewDetailedLcTileWidget(
                                tileKey: "status".toUpperCase(),
                                tileValue: viewModel.loadChange.status??"null"),
                            ViewDetailedLcTileWidget(
                                tileKey: "status date".toUpperCase(),
                                tileValue: viewModel.loadChange.statusDate??"null"),
                            ViewDetailedLcTileWidget(
                                tileKey: "ae employee id".toUpperCase(),
                                tileValue: viewModel.loadChange.aeEmpId??"null"),
                            ViewDetailedLcTileWidget(
                                tileKey: "staff employee id".toUpperCase(),
                                tileValue: viewModel.loadChange.lmEmpId??"null"),
                            ViewDetailedLcTileWidget(
                                tileKey: "reason".toUpperCase(),
                                tileValue: viewModel.loadChange.reason??"null"),
                            ViewDetailedLcTileWidget(
                                tileKey: "EBS reason".toUpperCase(),
                                tileValue: viewModel.loadChange.ebsRemarks??"null"),
                            ViewDetailedLcTileWidget(
                                tileKey: "EBS status".toUpperCase(),
                                tileValue: viewModel.loadChange.ebsStatus??"null"),
                            ViewDetailedLcTileWidget(
                                tileKey: "EBS date".toUpperCase(),
                                tileValue: viewModel.loadChange.ebsDate??"null"),

                            const ViewDetailedLcHeadWidget(title: "Meter particulars",),
                            ViewDetailedLcTileWidget(
                                tileKey: "meter make".toUpperCase(),
                                tileValue: viewModel.loadChange.meterMake??"null"),
                            ViewDetailedLcTileWidget(
                                tileKey: "meter capacity".toUpperCase(),
                                tileValue: viewModel.loadChange.meterCapacity??"null"),
                            ViewDetailedLcTileWidget(
                                tileKey: "meter serial No".toUpperCase(),
                                tileValue: viewModel.loadChange.meterSlNo??"null"),
                            ViewDetailedLcTileWidget(
                                tileKey: "meter final reading".toUpperCase(),
                                tileValue: viewModel.loadChange.meterFr.toString()??"null"),
                            Text("Test Report".toUpperCase()),
                            ViewDetailedLcImageWidget(imageUrl: viewModel.loadChange.testReportPath??""),
                            const SizedBox(height: 10),
                            if(data['status']=="VERIFIED")
                              SizedBox(width: double.infinity,child:PrimaryButton(text: "ASSIGN TO STAFF", onPressed: (){viewModel.getEmployeesOfSection(viewModel.loadChange);}),)
