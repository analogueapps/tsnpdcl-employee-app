...
class ViewDetailedPendingListScreen extends StatelessWidget {
  ...
  const ViewDetailedPendingListScreen(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ChangeNotifierProvider(
        create: (_) => ViewBriefDetailsPfViewmodel(
                  ...
                  return data == null
                      ...
                      : Column(
                          children: [
                            ...
                            ViewDetailedLcTileWidget(
                                tileKey: "WORK DESCRIPTION",
                                tileValue: data.workDescription),
                            ViewDetailedLcTileWidget(
                                tileKey: "FEEDER NAME",
                            ...
                            ViewDetailedLcTileWidget(
                                tileKey: "POLE - A LATITUDE",
                                tileValue: data.poleALat.toString()),
                            ViewDetailedLcTileWidget(
                                tileKey: "POLE - A LONGITUDE",
                                tileValue: data.poleALon.toString()),
                            Container(
                              margin: const EdgeInsets.only(top: 5.0),
                              padding: const EdgeInsets.only(
                                  top: 15.0, bottom: 15.0, left: 10),
                            ...
                            ViewDetailedLcTileWidget(
                                tileKey: "POLE - B LATITUDE",
                                tileValue: data.poleBLat.toString()),
                            ViewDetailedLcTileWidget(
                                tileKey: "POLE - B LONGITUDE",
                                tileValue: data.poleBLon.toString()),
                            ViewDetailedLcTileWidget(
                                tileKey: "DISTANCE B/W A & B",
                                tileValue: data.distance),
                            ViewDetailedLcTileWidget(
                                tileKey: "REMARKS",
                                tileValue: data.remarksBySurveyor),
                            status == "FINISHED"
                                ? Column(
                                    crossAxisAlignment:
                                    ...
                                    children: [
                                        ...
                                        ViewDetailedLcTileWidget(
                                            tileKey: "MIDDLE POLE LATITUDE",
                                            tileValue:
                                                data.middlePoleLat.toString()),
                                        ViewDetailedLcTileWidget(
                                            tileKey: "MIDDLE POLE LONGITUDE",
                                            tileValue:
                                                data.middlePoleLon.toString()),
                                        Container(
                                          margin:
                                              const EdgeInsets.only(top: 5.0),
                                          padding: const EdgeInsets.only(
                                ...
                                : const SizedBox(),
                            ViewDetailedLcTileWidget(
                                tileKey: "UPLOAD BY EMP ID",
                                tileValue: data.surveyorId),
                            ViewDetailedLcTileWidget(
                            ...
                            ViewDetailedLcTileWidget(
                                ...
                                tileValue:
                                    data.dateOfAbMarkedAsLong.toString()),
                            ViewDetailedLcTileWidget(
                                tileKey: "DATE OF MIDDLE POLE MARKED",
                                tileValue:
                                    data.dateOfMpMarkedAsLong.toString()),
                            const SizedBox(
                              height: doubleThirty,
                            )
                          ],
      ...
      floatingActionButton: status == "PENDING"
          ? FloatingActionButton(
              onPressed: () {
                Navigation.instance
                    .navigateTo(Routes.pendingListFloatingButton, args: {
                  'surveyID': surveyID,
                  'status': status,
                });
