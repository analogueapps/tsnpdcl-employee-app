                    ...
                    child: SingleChildScrollView(
                        ...
                        children: [
                          buildRow(
                              ...
                              DropdownButton<String>(
                                ...
                                items: viewModel.ssOptions.map((ssName) {
                      ...
                      Column(
                        children: viewModel.feederList.isEmpty
                            ...
                            : viewModel.feederList.map((report) {
                          final feederCode = report.optionId ?? "";
                          final feederName = report.optionName ?? "";

                          final isSelected = viewModel.selectedFeeders.any(
                                (item) => item["feederCode"] == feederCode,
                          );
                          ...
                          return checkBoxData(
                            ...
                            isSelected,
                              ...
                              setState(() {
                                if (newValue == true) {
                                  viewModel.selectedFeeders.add({
                                    "feederCode": feederCode,
                                    "feederName": feederName,
                                  });
                                } else {
                                  viewModel.selectedFeeders.removeWhere(
                                        (item) => item["feederCode"] == feederCode,
                                  );
                                }
                              });
