...
Widget _buildGroupWidgets(String? optionId) {
  switch (optionId) {
              ...
              child: Column(
                ...
                children: [
                 ...
                 "LT Bushes Status", Status.Good,Status.Damaged,"Good", "Damaged", viewModel.ltBushStatus, viewModel.isLtBushStatusDisabled, (value) => viewModel.selectLtBushStatus(value),
                  ...
                  // radioGroupWidget(
                  //   "LT Fuse Wire",  AbSwitch.Available,AbSwitch.NotAvailable,"Available", "Not Available", viewModel.ltFuseSet, viewModel.isLtFuseSetDisabled, (value) => viewModel.selectLtFuseSet(value),
                  // ),
                  // radioGroupWidget(
                  //   "Copper fuse wire status",  WireStatus.Available,WireStatus.NotAvailable,"Available", "Not Available", viewModel.ltFuseSet, viewModel.isLtFuseSetDisabled, (value) => viewModel.selectLtFuseSet(value),
                  // ),
    ...
    case "EARTHING"  :
      return Text("EARTHING");

    case "LT_NETWORK"  :
      return Text("LT_NETWORK");

    case "LA"  :
      return Text("LA");

    case "DTR_LOADING"  :
      return Text("DTR_LOADING");
